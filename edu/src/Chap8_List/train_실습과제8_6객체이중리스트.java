...
//        }
//
//        System.out.println("데이터 " + obj + "는 리스트에 없습니다. 삭제 실패.");
//
//    }
//
...
//                        break;
//                    case Merge_NewList:
//                        //기존 2개의 리스트를 합병하여 새로운 리스트를 생성(새로운 노드를 생성하여 추가)
//                        for (int i = 0; i < count; i++) {
//                            //3개의 객체를 연속으로 입력받아 l2 객체를 만든다 
//                            so = new SimpleObject();
//                            so.scanData("병합", 3);
...
//                        lst4.show();
//                        lst4.merge_NewList(lst2, SimpleObject.NO_ORDER);
//                        //merge 실행후 show로 결과 확인 - 새로운 노드를 만들지 않고 합병 - 난이도 상
